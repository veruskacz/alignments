...
directory_1 = "C:\Productivity\LinkAnalysis\{}-00".format(test)
directory_2 = "C:\Productivity\LinkAnalysis\{}-3".format(test)
...
Plt.cluster_d_test(union, network_size=net_size,  network_size_max=net_max_size,
                   ...
                   directory=directory_1, greater_equal=greater_equal, limit=None, activated=True)
